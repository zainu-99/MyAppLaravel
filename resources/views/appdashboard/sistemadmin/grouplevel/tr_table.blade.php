<tr @if($sparator =="") style="font-weight: bold" @endif>
    ...
    <td style="width: 237px" nowrap>   
        <a title="set role group" class="btn btn-xs btn-info text-light" href="{{ url('/appdashboard/adminsystem/grouplevel/rolegrouplevel/')}}/{{$child_GroupsLevel->id}}"><i class="fas fa-shield-alt"></i></a> 
